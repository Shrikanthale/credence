...
const link6="https://www.uwatchfree.cz/2020/04/panchayat-2020-season-1-complete-xfnee/";
const Tvfseries = () => {
    return (
        <>
        <h1><center>TOP 5 BEST WEB SERIES▶️</center></h1> 
        <Card 
            images={kota}
            title="Kota Factory"
            source="Youtube"
...
//Tvfseries.js Hi file App.js madhe import kar ni run kar project